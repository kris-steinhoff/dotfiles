...
3. Ask the user for the MR title. Always prompt — don't derive it.
...
git push -u origin HEAD \
  ...
  -o merge_request.title="<title from the user>"
```
...
- `merge_request.title="..."` — the title the user gave in step 3. Quote it.
...
- `-o merge_request.description="..."` — set the MR description.
